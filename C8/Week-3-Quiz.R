...
### 1. Load the cell segmentation data from the AppliedPredictiveModeling
...
### The bias is larger and the variance is smaller. Under leave one
...
### download the -code-olive-/code- dataset here: olive_data.zip.
### After unzipping the archive, you can load the file using the
### -code-load()-/code- function in R.)
###
### These data contain information on 572 different Italian olive
### oils from multiple regions in Italy. Fit a classification tree
### where Area is the outcome variable. Then predict the value of
### area for the following data frame using the tree command with
### all defaults
...
### 4. Load the South Africa Heart Disease Data and create training
### and test sets with the following code:
...
### behavior, and low density lipoprotein cholesterol as predictors.
### Calculate the misclassification rate for your model using this
...
### The order of the variables is: 2  1  5  6  8  4  9  3  7  10
