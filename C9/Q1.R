...
### 1. Consider the following code for the cars data set
...
### 2. Which of the following code uses the rCharts package to create a sortable and searchable
### data table for the airquality data set? Assume the rCharts package and the airquality data
### set have already been loaded into R.

dTable(airquality, sPaginationType = "full_numbers")

### 3. A basic shiny data product requires:

### A ui.R and server.R file or a A server.R file and a directory called www containing the
### relevant html files.

### 4. What is incorrect about the followig syntax in ui.R?
...
### 5. Consider the following code in ui.R
